...
> *"ศิลปิน (Artist) หรือแนวเพลง (Genre) ใดที่มีสัดส่วนการฟังจนจบเพลง (Completion Rate) สูงที่สุด และมีการกดข้ามเพลง (Skip Rate) ต่ำที่สุด? ข้อมูลนี้จะช่วยในการตัดสินใจซื้อลิขสิทธิ์เพลงหรือการโปรโมตศิลปิน"*

### Business Question 1.2 (มุมมอง CEO ด้านพฤติกรรมผู้ใช้งานและโครงสร้างพื้นฐาน)
> *"ช่วงเวลาใดของวัน (Peak Hours) หรือวันใดในสัปดาห์ที่มีปริมาณการฟังเพลงสูงสุดในแต่ละภูมิภาค (Location)? เพื่อใช้วางแผนการตลาดและปรับปรุงการรองรับของระบบ (Server Scale)"*
